import { CalendarBlank, Handshake, QrCode, Receipt, ShieldCheck, Signature } from "@phosphor-icons/react";
...
export function ProductionAdminOverview() {
  ...
  const modules = [
    ...
    { icon: Signature, title: "契約與簽署證據", text: "管理法律審閱 Gate、商業條件、邀請、簽署版本及私人契約文件。", to: "/admin/contracts", badge: "Legal Gate" },
  ];
