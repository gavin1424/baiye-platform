    ...
    <PublicLayout>
      <section className="pricing-hero">
        <div className="container">
          ...
          <p>先免費建立商家帳號，再前往正式商家方案頁選擇百工標準、AI 智慧商城或免 POS 機智慧點餐方案。</p>
        </div>
      </section>
...
export function FaqPage() {
  ...
  const extended = [
    ...
    { q: "商家如何建立公開頁與網站？", a: "先免費建立商家帳號，再依營運需求選擇正式方案；完成簽約與啟用後即可使用方案所含功能。" },
  ...
  return (
    <LegalPage
      ...
      sections={[
        ...
        [
          "方案與費用",
          "免費會員為 NT$0 的消費者購物帳號，不包含商家功能。商家需選擇並完成適用的正式方案與契約，價格與服務內容以伺服器正式方案目錄及簽署文件為準。",
        ],
