...
export function MerchantKitchenDisplayPage() {
  ...
  if (!session) return <main className="ordering-kds-page"><section className="ordering-center-card"><CookingPot size={48} /><h1>廚房看板需要商家登入</h1><p>請先從商家點餐管理入口登入，再開啟此 KDS。</p><Link className="btn btn-primary" to="/merchant-admin/ordering">前往商家接單</Link></section></main>;
