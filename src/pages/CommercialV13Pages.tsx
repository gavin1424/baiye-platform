...
export function PricingPageV13() {
  return <PublicLayout>
    ...
    <section className="pricing-faq section"><SectionHeading title="訂金代收與銷售抵付是選配服務" /><div className="faq-grid"><article><h3>一次付清方案</h3><p>商家已一次支付 NT$18,000，不再建立 NT$18,000 銷售抵付進度，避免重複收費。一般商家方案不按交易金額抽成。</p></article><article><h3>銷售抵付方案</h3><p>只有另行申請訂金代收與月結對帳服務、通過審核且有效契約載明者，才以每期平台作業服務費逐期抵付；完成後是否繼續計費依契約設定。</p></article></div><Link className="text-link" to="/services/deposit-settlement">查看訂金代收與月結對帳說明</Link></section>
