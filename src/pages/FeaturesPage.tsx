...
const groups: FeatureGroup[] = [
  ...
  },
  {
    ...
    icon: CalendarCheck,
    title: "網站預約與行程管理",
    description: "建立專屬線上預約頁面，顧客可直接透過網站選擇服務、日期與時間，快速完成預約。",
    salesLead: "如果預約還靠訊息一句一句確認時間，店家與顧客都會浪費時間。創百業讓顧客直接透過網站選擇服務、日期與時段，填寫資料後完成預約，店家再從後台統一管理。",
    promise: "顧客直接透過網站完成線上預約，手機即可操作，不需另外下載 App。",
    ...
    items: [
      { name: "線上選擇預約日期", description: "顧客可直接在網站查看並選擇可預約日期。", sellingPoint: "不必再透過訊息來回確認日期。" },
      { name: "選擇預約時段", description: "依營業時間、服務長度與既有行程呈現可預約時段。", sellingPoint: "顧客看到的都是店家真正能服務的時間。" },
      { name: "選擇服務項目", description: "清楚呈現服務內容，讓顧客在預約時直接選擇。", sellingPoint: "店家收到預約時就能掌握顧客需求。" },
      { name: "填寫顧客資料", description: "顧客填寫預約所需的基本聯絡資料。", sellingPoint: "預約資訊完整集中，不再散落在不同對話中。" },
      { name: "預約備註", description: "顧客可在送出前填寫需求與注意事項。", sellingPoint: "店家能提前準備，減少現場再次確認。" },
      { name: "商家查看預約紀錄", description: "商家可從後台集中查看顧客、服務與預約時間。", sellingPoint: "每天的預約安排一目了然。" },
      { name: "預約狀態管理", description: "集中管理待確認、已確認、已完成或取消等狀態。", sellingPoint: "預約進度更清楚，降低漏單與撞單。" },
      { name: "手機即可操作", description: "顧客與商家都可使用手機完成預約與管理。", sellingPoint: "外出或忙碌時也能快速處理。" },
      { name: "不需另外下載 App", description: "直接開啟網站即可使用完整預約流程。", sellingPoint: "降低顧客開始預約的門檻。" },
    ],
