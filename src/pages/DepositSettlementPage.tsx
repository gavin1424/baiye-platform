...
export function DepositSettlementPage() {
  ...
  const faqs = [
    ...
    ["NT$18,000 會不會重複收取？", "不會。一次付清方案不建立銷售抵付進度；銷售抵付方案才按有效契約逐期抵付。兩種方案不能同時啟用。"],
