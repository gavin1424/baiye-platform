...
INSERT OR IGNORE INTO merchant_plan_catalog(
  ...
  first_cycle_balance_minor,renewal_fee_minor,contract_version_id,features_json,environment
) VALUES
  ('baiye_standard_18000_addons',1,'百工標準方案','基礎數位升級',1800000,24,0,0,0,1800000,0,1800000,1800000,'merchant_service_v1_2_18000_addons','{"merchant_content_editable":false,"merchant_product_editable":false,"commerce_full":false,"cart_enabled":false,"softpos_enabled":false,"ordering_enabled":false,"base_product_limit":20}','staging'),
  ('baiye_commerce_ai_45000',2,'AI 智慧商城完整版','完整 AI 智慧商城',4500000,24,0,0,0,4500000,0,4500000,4500000,'merchant_commerce_ai_v1_0_45000','{"merchant_content_editable":true,"merchant_product_editable":true,"commerce_full":true,"cart_enabled":true,"softpos_enabled":false,"ordering_enabled":true}','staging'),
  ('baiye_softpos_24000',3,'免 POS 機智慧點餐','免 POS 機智慧點餐',2400000,24,3,300000,600000,2400000,600000,1800000,2400000,'merchant_softpos_v1_0_24000','{"merchant_content_editable":true,"merchant_product_editable":true,"commerce_full":false,"cart_enabled":false,"softpos_enabled":true,"ordering_enabled":true,"kds_enabled":true}','staging');
