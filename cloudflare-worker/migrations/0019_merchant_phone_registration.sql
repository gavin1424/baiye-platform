...
-- Production already received these additive identity/session columns through the
-- numeric-password release. Reuse the existing schema; do not rebuild or overwrite it.
