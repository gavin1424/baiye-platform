...
INSERT OR IGNORE INTO contract_versions (
  ...
  '<h1>創百業智慧鏈｜承攬夥伴合作契約 v1.5</h1><p><strong>STAGING / DRAFT FOR LEGAL REVIEW</strong></p><h2>一、契約雙方與合作性質</h2><p>甲方為平台正式設定所載法律主體；乙方為經核准之承攬夥伴。本合作屬獨立承攬／居間合作，非僱傭關係，不設打卡、固定工時、排班或固定工作地點。</p><h2>二、合作期間</h2><p>本契約合作期間以三個月為一期，自契約生效日起計算。每一期屆滿後之續約、終止或後續合作方式，依雙方當時有效之契約版本、平台規範及雙方約定辦理。</p><h2>三、有效成交與五級獎勵</h2><p>有效成交須具正確推薦歸因、完成當期標準方案全額付款，且非續約、維護費、重複、取消、退款、虛假、拆單或測試案件。歷史累計 1～10 件每件 NT$1,000；11～30 件每件 NT$1,500；31～70 件每件 NT$2,000；71～120 件每件 NT$2,500；121 件以上每件 NT$3,000。升級非追溯，自下一有效成交適用。</p><h2>四、資格維持與升降級</h2><p>初階、進階每月最低 1 件；中階 2 件；高階 3 件；資深 4 件。高階身份未達最低資格時，次月獎勵降一階但歷史身份不變。初階自啟用後第一個完整曆月起，連續兩個完整曆月 0 件者依契約終止。</p><h2>五、VIP 獎勵</h2><p>每三年為獨立週期；單一週期累計 1,000 家有效新商家，經正式審核後可取得一次性稅前 NT$1,000,000，每週期最多一次且不得跨期累計。</p><h2>六、退款、稅務與禁止行為</h2><p>退款或失效案件之佣金與獎勵依約沖回。稅務依適用法令及乙方實際稅務身分辦理，不硬列固定稅率。乙方不得私收平台服務款、假交易、拆單、不實廣告、未授權承諾或洩漏商業機密。</p><h2>七、個資、歸因、終止與既有案件</h2><p>乙方應依合法目的最小化處理個資；推薦歸因以平台稽核紀錄為準。終止後之既有案件、報酬及資料保存依本契約與法令處理。</p><h2>八、電子形式、正楷簽署與契約版本</h2><p>雙方同意以電子形式完成契約程序。乙方應由本人以正楷清楚簽寫完整姓名。手寫簽名軌跡、明確同意、時間、Session、IP、User-Agent 與雜湊為線上簽署證據，不等同憑證式數位簽章或政府認證；平台不以本系統宣稱辨識本人字跡。條款變更以新版本或補充協議處理，舊文件永久保留。</p><h2>九、準據法與管轄</h2><p>依中華民國法律；管轄條款須於正式法律審閱時確認。</p><p><strong>LEGAL_REVIEW_REQUIRED：未經台灣執業律師審閱及平台授權管理員核准前，不得於 Production 簽署。</strong></p>',
  '6tOhpup7SswvOk4pWSIM2MPpsUqNTp4ErNXP8ue_VYY','2026-08-30',0,1,1,'pending_review',3,1
);
