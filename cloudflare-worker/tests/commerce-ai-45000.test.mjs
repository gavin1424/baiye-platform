...
test("CA45-07 cart creates an unpaid order and never implies Provider payment", async () => {
  ...
  db.sqlite.prepare("UPDATE merchant_ordering_settings SET consent_version='2026-08-27' WHERE merchant_id=?").run(merchantId);
  ...
  let req = request("/api/ordering/qr/commerce-cart-code-45000/join", "POST", { phone: "0933444555", password: "48270615", password_confirm: "48270615", privacy_consent: true, consent_version: "2026-08-27", device_id: "commerce-cart-test" });
