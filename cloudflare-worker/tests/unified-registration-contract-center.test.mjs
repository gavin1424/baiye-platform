...
test("UNIFIED-01 migrations are unique and ordered 0023 commerce, 0024 SoftPOS, 0025 standard, 0026 integration", () => {
  ...
  assert.deepEqual(names,["0023_contract_commerce_ai_45000.sql","0024_contract_softpos_24000.sql","0025_contract_standard_addons.sql","0026_unified_registration_contract_center.sql"]);
});
