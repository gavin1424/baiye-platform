...
test("SP01 migration keeps the unique 0023-0026 integration sequence and immutable integer plan data", async () => {
  ...
  assert.ok(migrations.includes("0023_merchant_admin_v1.sql"));
  assert.ok(migrations.includes("0024_contract_commerce_ai_45000.sql"));
  assert.ok(migrations.includes("0025_contract_softpos_24000.sql"));
  assert.ok(migrations.includes("0026_contract_standard_addons.sql"));
  assert.ok(migrations.includes("0027_unified_registration_contract_center.sql"));
