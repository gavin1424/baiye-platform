export const COMMERCIAL_CATALOG_VERSION = "2026-09-11.payment-v1";
...
export const MERCHANT_PLANS = Object.freeze([
  Object.freeze({
    ...
    contract_version: "merchant_service_v1_3_18000_payment",
  ...
  Object.freeze({
    ...
    contract_total_amount_minor: 5000000,
    payment_due_at_signature_minor: 5000000,
    remaining_amount_minor: 0,
    trial_period_months: 0,
    post_trial_payment_minor: 0,
    payment_schedule_type: "SIGNATURE_FULL",
  ...
  Object.freeze({
    ...
    features: ["3 個月試用期間", "QR 手機點餐", "訂單與出餐看板", "庫存與售完同步", "會員營運", "手機／平板即可接單"],
    renewal_terms: "簽約首期款 NT$6,000；3 個月試用期屆滿後支付尾款 NT$18,000，合計 NT$24,000。",
