...
test("partner application UX maps every lifecycle state without exposing account data", () => {
  ...
  assert.deepEqual(partnerWorkflowStatus({ status: "pending_contract", approved_at: null }, null, at), {
    code: "PARTNER_DATA_UPDATE_REQUIRED", state: "pending_activation", message: "承攬夥伴資料正在更新，完成後即可繼續啟用。",
  });
